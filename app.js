...
(function () {
  ...
  const POSH = {
    ...
    shareText:
      "POSH helps parents and safe adults build safer digital families with safety checks, topic pathways, device guidance, family rules, platform awareness, warning signs and calm action pathways.",

    searchPlaceholder: "Search topics, apps, games, devices, PDFs or help",
    maxSearchResults: 10,
    maxTocItems: 8,
    maxRelatedItems: 6
  };
  ...
  const TOPIC_PATHWAYS = {
    ...
    book3: POSH.redFlags,
    book4: POSH.emotionalRegulation,
    book5: POSH.frustrationIntolerance,
  ...
  const NAV_GROUPS = [
    {
      ...
      links: [
        ...
        { href: POSH.parentSystem, label: "POSH Parent System", type: "System", keywords: "parent system family plan rules visibility monitoring conversations digital resilience foundation" },
    ...
    {
      title: "Topic Pathways & Free Guides",
      links: [
        ...
        { href: POSH.topicHub, label: "Digital Resilience Topic Pathways", type: "Topic Hub", keywords: "digital resilience topic pathways series hub book topics parent guidance" },
        { href: POSH.topicFinder, label: "Which Topic Should I Start With?", type: "Topic Finder", keywords: "which topic start guide parent teacher coach grandparent pathway" },
        { href: POSH.parentSystem, label: "Raising Digitally Resilient Kids Topic", type: "Topic Pathway", keywords: "book 1 raising digitally resilient kids foundation digital resilience parent system" },
        { href: POSH.platformRisks, label: "The Digital Playground Topic", type: "Topic Pathway", keywords: "book 2 digital playground games chats apps algorithms livestreams dms" },
        { href: POSH.redFlags, label: "New Risks Families Face Topic", type: "Topic Pathway", keywords: "book 3 new risks family AI hidden access grooming pressure secrecy red flags" },
        { href: POSH.emotionalRegulation, label: "Emotional Regulation Online Topic", type: "Topic Pathway", keywords: "book 4 emotional regulation screen stress shame big feelings gaming rage" },
        { href: POSH.frustrationIntolerance, label: "Frustration Tolerance Topic", type: "Topic Pathway", keywords: "book 5 frustration tolerance grit patience losing hearing no screen transitions" },
        { href: POSH.criticalThinking, label: "Thinking Before Clicking Topic", type: "Topic Pathway", keywords: "book 6 thinking before clicking pause links downloads screenshots reply share post critical thinking" },
        { href: POSH.manipulated, label: "Manipulation & Misinformation Topic", type: "Topic Pathway", keywords: "book 7 spotting manipulation misinformation scams fake content rumours AI influence" },
        { href: POSH.executiveOnlineSafety, label: "Executive Functioning Topic", type: "Topic Pathway", keywords: "book 8 executive functioning planning focus memory organisation transitions follow through" },
        { href: POSH.confidence, label: "Confidence Is a Safety Skill Topic", type: "Topic Pathway", keywords: "book 9 confidence safety skill self trust speaking up worth courage people pleasing" },
        { href: POSH.houseRules, label: "Healthy Boundaries Topic", type: "Topic Pathway", keywords: "book 10 healthy boundaries online offline privacy respect consent no relationships house rules" }
      ]
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { href: POSH.manipulated, label: "Manipulation", type: "Warning Signs", keywords: "child manipulated online emotional pressure control secrecy misinformation" },
    ...
    },
    {
      ...
      links: [
        { href: POSH.platformRisks, label: "Platform Risk Overview", type: "Hub", keywords: "platform risk overview apps games contact secrecy pressure digital playground" },
    ...
    },
    {
      ...
      links: [
        { href: POSH.houseRules, label: "House Rules", type: "Rules", keywords: "house rules boundaries devices bedrooms passcodes healthy boundaries online offline" },
        ...
        { href: POSH.executiveOnlineSafety, label: "Executive Functioning", type: "Thinking Skills", keywords: "executive functioning online safety child thinking skills" },
        ...
        { href: POSH.criticalThinking, label: "Critical Thinking", type: "Thinking Skills", keywords: "critical thinking online safety claims pressure thinking before clicking" }
      ]
    },
    {
  ...
  const SEARCH_ALIASES = {
    ...
    paperback: ["digital resilience topic pathways", "which topic should i start with"],
    hardcover: ["digital resilience topic pathways", "which topic should i start with"],
    ...
    "digital resilience": ["posh parent system", "digital resilience topic pathways"],
    "raising digitally resilient kids": ["posh parent system", "free starter guide"],
    "digital playground": ["platform risk overview", "gaming safety"],
    "new risks": ["red flags", "grooming signs", "predator playbook"],
    "emotional regulation": ["emotional regulation", "parent scripts"],
    "frustration tolerance": ["frustration tolerance", "pause before reacting"],
    "thinking before clicking": ["critical thinking", "decision making"],
    misinformation: ["manipulation", "critical thinking"],
    manipulation: ["manipulation", "red flags", "grooming signs"],
  ...
  function fixKnownBrokenInternalLinks(root = document) {
    qsa("a[href]", root).forEach(link => {
      ...
      link.dataset.poshRedirectedToTopic = "true";
    });
  }
    ...
    return `
      <div class="nav-shell">
        ...
        <div class="nav-support-row">
          ...
          <a href="${POSH.topicHub}" class="nav-support-link" data-track="nav_topics">Topic Pathways</a>
  ...
  function inferCTAByPage(page) {
    ...
    if (TOPIC_PAGES.includes(page)) {
      return {
        title: "Keep moving through the POSH topic pathways",
        text: "Books will be added later. For now, use the live POSH topic pages to learn the pattern, practise the words and take the next safe step.",
        actions: [
          { href: POSH.smarterChildrenFree, label: "Free Guide" },
          { href: POSH.topicHub, label: "Topic Pathways" },
          { href: POSH.topicFinder, label: "Choose Topic" },
  ...
  function injectNextStepStrip() {
    ...
    strip.innerHTML = `
      ...
      <p>Choose the safest next step. POSH is designed to keep you moving without panic or dead ends.</p>
      <div class="posh-next-step-actions">
        <a href="${POSH.home}">Home</a>
        <a href="${POSH.start}">Start Here</a>
        <a href="${POSH.quiz}">Safety Score</a>
        <a href="${POSH.redFlags}">Red Flags</a>
        <a href="${POSH.devices}">Device Safety</a>

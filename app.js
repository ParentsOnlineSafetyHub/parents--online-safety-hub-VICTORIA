...
/*
POSH app.js — Premium Site Upgrade
Version: 2026-06-30
Purpose:
- Keep POSH simple, fast and easy to navigate.
- Strengthen the book ecosystem across the site.
- Send parents and safe adults to the right page at the right time.
...
smarterChildren: "v3-smarter-children-safer-children.html",
smarterChildrenFree: "v3-smarter-children-safer-children-free-guide.html",
bookHub: "v3-posh-digital-resilience-series.html",
whichBook: "v3-which-posh-book-should-i-read-first.html",
book1: "v3-raising-digitally-resilient-kids.html",
book2: "v3-the-digital-playground.html",
book3: "v3-new-risks-families-face.html",
book4: "v3-emotional-regulation-online.html",
book5: "v3-frustration-tolerance-digital-world.html",
book6: "v3-thinking-before-clicking.html",
book7: "v3-spotting-manipulation-misinformation.html",
book8: "v3-executive-functioning-online-safety.html",
book9: "v3-confidence-is-a-safety-skill.html",
book10: "v3-healthy-boundaries-online-offline.html",
...
shareText:
  "POSH helps parents and safe adults build safer digital families with books, safety checks, device guidance, family rules, platform awareness, warning signs and calm action pathways.",

searchPlaceholder: "Search books, apps, games, devices, PDFs or topics",
maxSearchResults: 10,
maxTocItems: 8,
maxRelatedItems: 6
...
{
title: "Books & POSH Series",
links: [
{ href: POSH.smarterChildrenFree, label: "Free Starter Guide", type: "Free Book", keywords: "smarter children safer children free guide gateway book download posh starter" },
{ href: POSH.smarterChildren, label: "Smarter Children, Safer Children", type: "Gateway Book", keywords: "standalone gateway book smarter children safer children posh ecosystem" },
{ href: POSH.bookHub, label: "10-Book Series Hub", type: "Series", keywords: "posh digital resilience series books book hub 10 books raising digitally resilient kids" },
{ href: POSH.whichBook, label: "Which Book Should I Start With?", type: "Guide", keywords: "which book start guide parent teacher coach grandparent pathway" },
{ href: POSH.book1, label: "Book 1: Raising Digitally Resilient Kids", type: "Book 1", keywords: "foundation digital resilience confidence regulation critical thinking boundaries" },
{ href: POSH.book2, label: "Book 2: The Digital Playground", type: "Book 2", keywords: "games chats apps digital playground algorithms voice chat dms livestreams" },
{ href: POSH.book3, label: "Book 3: The New Risks Families Face", type: "Book 3", keywords: "new risks family AI hidden access grooming pressure secrecy" },
{ href: POSH.book4, label: "Book 4: Emotional Regulation Online", type: "Book 4", keywords: "emotional regulation screen stress online shame big feelings gaming rage" },
{ href: POSH.book5, label: "Book 5: Frustration Tolerance", type: "Book 5", keywords: "frustration tolerance grit patience losing hearing no screen transitions" },
{ href: POSH.book6, label: "Book 6: Thinking Before Clicking", type: "Book 6", keywords: "thinking before clicking pause links downloads screenshots reply share post" },
{ href: POSH.book7, label: "Book 7: Manipulation & Misinformation", type: "Book 7", keywords: "spotting manipulation misinformation scams fake content rumours AI influence" },
{ href: POSH.book8, label: "Book 8: Executive Functioning", type: "Book 8", keywords: "executive functioning planning focus memory organisation transitions follow through" },
{ href: POSH.book9, label: "Book 9: Confidence Is a Safety Skill", type: "Book 9", keywords: "confidence safety skill self trust speaking up worth courage people pleasing" },
{ href: POSH.book10, label: "Book 10: Healthy Boundaries", type: "Book 10", keywords: "healthy boundaries online offline privacy respect consent no relationships" }
]
},
{
...
{ href: POSH.reportingUSA, label: "Reporting USA", type: "Reporting", keywords: "usa reporting ncmec cybertipline ic3 police child safety" },
{ href: POSH.reportingUK, label: "Reporting UK", type: "Reporting", keywords: "uk reporting ceop iwf childline police child safety" },
{ href: POSH.reportingEurope, label: "Reporting Europe", type: "Reporting", keywords: "europe reporting inhope national hotline police child safety" },
...
gifting: ["in-game currency risk", "free robux scam safety"],
...
downloads: ["all pdf downloads", "download guides", "free starter guide"],
pdf: ["all pdf downloads", "download guides", "free starter guide"],
...
executive: ["executive functioning", "pause before reacting", "impulse control", "book 8: executive functioning"],
...
book: ["10-book series hub", "which book should i start with", "free starter guide"],
books: ["10-book series hub", "which book should i start with", "free starter guide"],
series: ["10-book series hub", "which book should i start with", "book 1: raising digitally resilient kids"],
ebook: ["free starter guide", "10-book series hub"],
paperback: ["10-book series hub", "which book should i start with"],
hardcover: ["10-book series hub", "which book should i start with"],
"smarter children": ["smarter children, safer children", "free starter guide", "10-book series hub"],
"safer children": ["smarter children, safer children", "free starter guide", "10-book series hub"],
"digital resilience": ["book 1: raising digitally resilient kids", "10-book series hub"],
"digital playground": ["book 2: the digital playground"],
"which book": ["which book should i start with", "10-book series hub"],
...
"index.html": [POSH.smarterChildrenFree, POSH.bookHub, POSH.whichBook, POSH.quiz, POSH.parentSystem, POSH.trainingEveryone, POSH.urgentHelp],
"v3-start.html": [POSH.smarterChildrenFree, POSH.bookHub, POSH.safetyLanes, POSH.quiz, POSH.parentSystem, POSH.redFlags, POSH.devices, POSH.reporting],
"v3-smarter-children-safer-children.html": [POSH.smarterChildrenFree, POSH.bookHub, POSH.whichBook, POSH.book1, POSH.book2, POSH.trainingEveryone],
"v3-smarter-children-safer-children-free-guide.html": [POSH.bookHub, POSH.whichBook, POSH.book1, POSH.book2, POSH.downloads, POSH.share],
"v3-posh-digital-resilience-series.html": [POSH.smarterChildrenFree, POSH.whichBook, POSH.book1, POSH.book2, POSH.book3, POSH.book10],
"v3-which-posh-book-should-i-read-first.html": [POSH.smarterChildrenFree, POSH.bookHub, POSH.book1, POSH.book2, POSH.book3, POSH.trainingEveryone],
"v3-raising-digitally-resilient-kids.html": [POSH.bookHub, POSH.book2, POSH.smarterChildrenFree, POSH.parentSystem, POSH.quiz],
"v3-the-digital-playground.html": [POSH.bookHub, POSH.book1, POSH.book3, POSH.platformRisks, POSH.gaming],
"v3-new-risks-families-face.html": [POSH.bookHub, POSH.book2, POSH.redFlags, POSH.playbook, POSH.reporting],
"v3-emotional-regulation-online.html": [POSH.bookHub, POSH.book5, POSH.emotionalRegulation, POSH.parentScripts],
"v3-frustration-tolerance-digital-world.html": [POSH.bookHub, POSH.book4, POSH.frustrationIntolerance, POSH.pauseBeforeReacting],
"v3-thinking-before-clicking.html": [POSH.bookHub, POSH.book7, POSH.criticalThinking, POSH.evidence],
"v3-spotting-manipulation-misinformation.html": [POSH.bookHub, POSH.book6, POSH.algorithm, POSH.manipulated],
"v3-executive-functioning-online-safety.html": [POSH.bookHub, POSH.book9, POSH.executiveFunctioning, POSH.onlineScenarios],
"v3-confidence-is-a-safety-skill.html": [POSH.bookHub, POSH.book8, POSH.parentScripts, POSH.whatSafeAdultsSay],
"v3-healthy-boundaries-online-offline.html": [POSH.bookHub, POSH.book9, POSH.houseRules, POSH.trustProtection],

"v3-posh-safety-lanes.html": [POSH.urgentHelp, POSH.redFlags, POSH.platformRisks, POSH.parentSystem, POSH.onlineScenarios],
"v3-posh-parent-system.html": [POSH.houseRules, POSH.monitorTrust, POSH.parentScripts, POSH.onlineScenarios, POSH.quiz, POSH.book1],
...
"v3-safety-score.html": [POSH.parentSystem, POSH.redFlags, POSH.devices, POSH.houseRules, POSH.whichBook],
...
"v3-platform-risks-overview.html": [POSH.roblox, POSH.discord, POSH.snapchat, POSH.gaming, POSH.devices, POSH.book2],
...
"v3-executive-functioning.html": [POSH.onlineScenarios, POSH.pauseBeforeReacting, POSH.impulseControl, POSH.emotionalRegulation, POSH.book8],
"v3-executive-functioning-online-safety.html": [POSH.executiveFunctioning, POSH.book8, POSH.onlineScenarios, POSH.neurodivergentExecutive],
...
"v3-support.html": [POSH.start, POSH.downloads, POSH.quiz, POSH.share, POSH.bookHub],
"v3-warning.html": [POSH.start, POSH.reporting, POSH.redFlags, POSH.downloads],
"v3-why-posh-exists.html": [POSH.smarterChildrenFree, POSH.bookHub, POSH.start, POSH.parentSystem, POSH.share, POSH.support]
...
return "<a href="${link.href}" data-label="${escapeHtml(link.label)}" data-type="${escapeHtml(link.type || "")}" data-keywords="${escapeHtml(link.keywords || "")}"> ${escapeHtml(link.label)} </a>";
}

function buildNavHTML() {
const groupsHtml = NAV_GROUPS.map(group => "<details class="nav-group"> <summary>${escapeHtml(group.title)}</summary> <nav>${group.links.map(buildNavLink).join("")}</nav> </details>").join("");
...
return `
  <div class="nav-shell">
    ...
    <div class="nav-support-row">
      <a href="${POSH.smarterChildrenFree}" class="nav-support-link" data-track="nav_free_guide">Free Guide</a>
      <a href="${POSH.bookHub}" class="nav-support-link" data-track="nav_books">Book Series</a>
...
return "<a href="${link.href}" class="nav-search-result" data-query="${escapeHtml(query)}"> <span class="nav-search-result-title">${escapeHtml(link.label)}</span> <span class="nav-search-result-meta">${escapeHtml(link.type || "Page")}</span> <span class="nav-search-result-desc">${escapeHtml(link.keywords || "")}</span> </a>";
}
...
panel.innerHTML = `
  ...
  <div class="posh-share-panel-actions">
    ...
    <a href="${POSH.downloads}" data-track="share_panel_downloads">All Downloads</a>
  </div>
`;
...
if (BOOK_PAGES.includes(page)) {
  return {
    title: "Keep learning through the POSH ecosystem",
    text: "Each POSH book has its own lane, but the skills connect. Use the free guide, the series hub and the safety pathways to keep the learning moving from awareness into action.",
    actions: [
      { href: POSH.smarterChildrenFree, label: "Free Guide" },
      { href: POSH.bookHub, label: "Series Hub" },
      { href: POSH.whichBook, label: "Which Book Next?" },
...
if (/^v3-game-/.test(page) || page === POSH.gaming || page === POSH.robuxScam || page === POSH.inGameCurrency) {
  return {
    title: "Do not stop at the game itself",
    ...
    actions: [
      { href: POSH.book2, label: "The Digital Playground" },
...
if (
  ...
  return {
    ...
    actions: [
      { href: POSH.book3, label: "New Risks" },
      { href: POSH.parentScripts, label: "Parent Scripts" },
...
strip.innerHTML = `
  <div class="posh-support-strip-inner">
    ...
    <div class="posh-support-strip-actions">
      ...
      <a href="${POSH.smarterChildrenFree}" data-track="support_strip_free_guide">Free Guide</a>
...
footer.innerHTML = `
  ...
  <div class="posh-footer-prompt-actions">
    ...
    <a href="${POSH.smarterChildrenFree}" data-track="footer_free_guide">Free Guide</a>
...
if (BOOK_PAGES.includes(current)) document.body.classList.add("page-is-book");
